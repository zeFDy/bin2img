...
int main()
{
	#define FILENAME				"myBoot.bin"
	#define	OUTPUT_FILENAME			"myBoot.img"
	#define	OUTPUT_FILENAME_QUAD	"myBootQuad.img"
	...
	fopen_s(&myOutputFile, OUTPUT_FILENAME, "wb");
	fwrite(ucOriginalBuffer, 1, PADDED_SIZE, myOutputFile);
	fclose(myOutputFile);

	fopen_s(&myOutputFile, OUTPUT_FILENAME_QUAD, "wb");
	fwrite(ucOriginalBuffer, 1, PADDED_SIZE, myOutputFile);
	fwrite(ucOriginalBuffer, 1, PADDED_SIZE, myOutputFile);
	fwrite(ucOriginalBuffer, 1, PADDED_SIZE, myOutputFile);
	fwrite(ucOriginalBuffer, 1, PADDED_SIZE, myOutputFile);
